...
initdb
pg_ctl start
echo "host replication repl_user 172.30.1.0/16 trust" >> /var/lib/postgresql/data/pg_hba.conf 
echo "host all all 172.30.1.0/16 trust" >> /var/lib/postgresql/data/pg_hba.conf 
